...
from .SD_dataset import SD_DataModule

dataset_dict = {'SD': SD_DataModule, 'NYU_Depth_v2': Nyu2DataModule, 'KITTI_eigen': KITTIDataModule, 'KITTI_eigen_Test': KITTIDataModuleTest, 'NYU_Depth_v2_Test': Nyu2DataModuleTest}
