...
params = {
  ...
  'root_dir_list': [
      '/usr/project/gen_data/CURRENT_FINAL_OUT/train/FT/'
    ], # Dir for the training data
  'val_dir_list': [
      '/usr/project/gen_data/CURRENT_FINAL_OUT/val/FT/'
    ], # Dir for the validation data
  'scale':  0.15890, # scale for Dense Dataset
  'trans' : 18.0102, # translation for Dense Dataset
